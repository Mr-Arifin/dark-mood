...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            mr.arifin khan
     \033[1;91m➣ \033[1;91mFACEBOOK   :            https://www.facebook.com/profile.php?id=100071322295410
     \033[1;92m➣ \033[1;92mWHATSAPP   :            01917659559
     \033[1;91m➣ \033[1;91mGITHUB     :            Mr-Arifin 
...
a=requests.get("https://justpaste.it/2ur6g").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
